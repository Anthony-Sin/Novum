...
# The Specific Forensic Task to be Completed in this Work Phase Room
${this.task}
`.trim();
    ...
    while (!done) {
      ...
      if (feedback) {
        switch (feedback.action) {
          ...
          case 'RESTART':
            this.updateLog('The overseer has decided to restart the investigation.', false);
          ...
          case 'ABANDON':
            ...
            this.updateProgressLog(`\n#### Overseer\nThe Overseer has decided to abandon the investigation. Abandoning Work Phase.`,);
